        ...
        <div class="card">
          <div class="card-body py-2">
            ...
            <p class="small">
                ...
                <a href="../comments/comments.php?id=<?php echo $_SESSION['post_info']['id'];?>&name=<?php echo $_SESSION['post_info']['names']; ?>&profile_photo=<?php echo $_SESSION['post_info']['profile_photo'];?>">
                    <?php  
            ...
            <div class="small d-flex justify-content-start">
              <a href="#!" class="d-flex align-items-center me-3">
                ...
                <h6>
                <p class="mb-0 text-success">Comments
                  <?php
